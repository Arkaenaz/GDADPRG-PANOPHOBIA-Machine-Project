...
#ifndef CANDY_TUI_ROOMS_MASTERS_BED_DOOR_H
#define CANDY_TUI_ROOMS_MASTERS_BED_DOOR_H
...
namespace rooms {
    ...
    class MastersBedDoor : public Interactable {
        public:
            MastersBedDoor(int nX, int nY);
