...
#ifndef CANDY_TUI_ROOMS_LIVING_ROOM_DOOR_H
#define CANDY_TUI_ROOMS_LIVING_ROOM_DOOR_H
...
namespace rooms {
    ...
    class LivingRoomDoor : public Interactable {
        public:
            LivingRoomDoor(int nX, int nY);
