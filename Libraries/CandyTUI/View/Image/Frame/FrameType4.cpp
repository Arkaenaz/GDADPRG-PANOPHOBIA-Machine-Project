...
#include "FrameType4.h"

using namespace images;

/*
    Pre-requisites:
        [1] CBounds.nWidth must be [4n - 1], for [n > 1].
        [2] CBright has at least 4 colours.
*/
FrameType4::FrameType4(Palette CBright, Bounds CBounds)
...
std::vector<ImageAnnotation> FrameType4::createAnnotationVector(Bounds CBounds) {
...
Palette FrameType4::createDarkPalette() {
