...
*/
FrameType2::FrameType2(Palette CBright, Bounds CBounds)
...
std::vector<ImageAnnotation> FrameType2::createAnnotationVector(Bounds CBounds) {
...
Palette FrameType2::createDarkPalette() {
